...
import { getUserBookings } from "@/libs(LIBRARY)/apis";
    ...
    <div className="container mx-auto px-2 md:px-4 py-10">
        <div className="grid md:grid-cols-12 gap-10">
            ...
            <div className="md:col-span-8 lg:col-span-9">
                <div className="flex items-center">
                    <h5 className="text-2xl font-bold mr-3">HABARI, {userData.name}</h5>
                </div>

                <div className="md:hidden w-14 h-14 rounded-full overflow-hidden">
                    <Image className="img scale-animation" src={userData.image} alt="USER NAME" width={56} height={56}/>
                </div>
                ...
                {currentNav === "bookings" ? (userBookings && <Table toggleRatingModal={toggleRatingModal} bookingDetails={userBookings} setRoomId={setRoomId}/>) : (<></>)}
