...
const BookRoomCta: FC<Props> = (props) => {
    ...
    const {price, discount, specialNote, checkinDate, setCheckinDate, checkoutDate, setCheckoutDate, setAdults, setNoOfChildren, calcMinCheckoutDate, adults, noOfchildren, isBooked, handleBookNowClick} = props;
    ...
    <div className="px-7 py-6">
        ...
        <div className="flex mt-4">
            ...
            <div className="w-1/2 pl-2">
                ...
                <input type="number" value={noOfchildren} id="children" onChange={(e) => setNoOfChildren(+e.target.value)} min={0} max={3} className="w-full border border-gray-300 rounded-lg p-2.5"/>
            </div>
        </div>
